      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 flex flex-col justify-center p-8 md:p-16 bg-gray-100 container">
          <h1 className="text-3xl font-helvetica md:text-2xl font-medium text-gray-800 mb-9">
            Our service isn&apos;t just personal&lsquo; it&apos;s actually hyper
            personally exquisite
          </h1>
          <p className="text-gray-500 mb-7">
            When we started Avion&lsquo; the idea was simple. Make high quality
            furniture affordable and available for the mass market.
          </p>
          <p className="text-gray-500 mb-28">
            Handmade&lsquo; and lovingly crafted furniture and homeware is what
            we live&lsquo; breathe and design so our Chelsea boutique become the
